import{_ as n,o as s,c as e,d as a}from"./app-dJGclpHq.js";const t={},i=a(`<h1 id="celery异步任务" tabindex="-1"><a class="header-anchor" href="#celery异步任务" aria-hidden="true">#</a> celery异步任务</h1><p>在使用celery时，需要控制异步任务</p><p>任务终止有多种情况</p><ul><li>任务内部错误</li><li>celery被杀死</li><li>手动结束任务（通过celery控制）</li></ul><p>这些需要我们特殊注意</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token decorator annotation punctuation">@shared_task</span><span class="token punctuation">(</span>ignore_result<span class="token operator">=</span><span class="token boolean">True</span><span class="token punctuation">,</span> time_limit<span class="token operator">=</span><span class="token number">3600</span><span class="token operator">*</span><span class="token number">24</span><span class="token punctuation">)</span>
