import{_ as n,o as s,c as a,d as t}from"./app-dJGclpHq.js";const p={},e=t(`<h1 id="skill" tabindex="-1"><a class="header-anchor" href="#skill" aria-hidden="true">#</a> skill</h1><h3 id="python-打印行号" tabindex="-1"><a class="header-anchor" href="#python-打印行号" aria-hidden="true">#</a> python 打印行号</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
